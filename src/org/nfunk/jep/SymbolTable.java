...
public class SymbolTable extends Hashtable
{
	...
	* Returns null if variable does not exist. */
	 ...
	 * 
	 * MATOG: JANUAR 2006: Tato metoda nezlikviduje hodnotu
	 * premennej v parseri !
	 * Vysledok operacii:
	 * parser.parseExpression( "a=3" );
	 * parser.getValue();
	 * parser.getSymbolTable().clearValues();
	 * parser.parseExpression( "a+3" );
	 * parser.getValue();
	 *
	 * je 6, nie null ani NaN.
	 *
	 * Na vycistenie hodnot premennych treba pouzit nullValues(), pripadne
  	 * tvrdsie parser.getSymbolTable().clear(), co ale zlikviduje aj popridavane konstanty.
	 */
	...
	/**
	 * Set the values of all variables to null.
	 * Constants are preserved.
	 * Also the method {@link Variable#setValidValue Variable.setValidValue( false ) }
	 * is called.
	 *
	 * Vid poznamku ku clearValues.
	 * Pouzivat medzi 2 volaniami parser.parse na vynulovanie hodnot vsetkych nekonstantnych premennych.
	 */
