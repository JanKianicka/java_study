 ...
 * @author nathan
 * 
 * $Id: CommandEvaluator.java,v 1.3 2012/03/02 07:56:41 matog Exp $
 */
public class CommandEvaluator {
	...
	public Object evaluate(CommandElement[] commands, SymbolTable symTab) throws Exception {	// NOSONAR kvoli spatnej kompatibilite Exception
		...
		if (stack.size() != 1) {
			throw new Exception("CommandEvaluator.evaluate(): Stack size is not 1");	// NOSONAR kvoli spatnej kompatibilite Exception
		}
		return stack.pop();
	}
}
