 ...
 * 
 * $Id: Complex.java,v 1.3 2012/02/28 20:08:21 matog Exp $
 */
...
// Various functions
	...
	public Complex power(double exponent) {
		...
		if (specialCase && factor*exponent == (int)(factor*exponent)) {	// NOSONAR MatoG 3.10.2011: tu fakt chceme robit porovnavanie nad float/double
