 ...
 *
 * $Id: Comparative.java,v 1.5 2012/02/29 11:01:17 matog Exp $
 */
public class Comparative extends PostfixMathCommand
{
	...
	public boolean lt(Object param1,Object param2) 	throws ParseException
	{
		if ((param1 instanceof Date) && (param2 instanceof Date)) {
			long x = ((Date)param1).getTime();
			long y = ((Date)param2).getTime();
			return (x<y);
		}
	...
	public boolean eq(Object param1,Object param2)	throws ParseException
	{
		if ((param1 instanceof Date) && (param2 instanceof Date)) {
			long x = ((Date)param1).getTime();
			long y = ((Date)param2).getTime();
			return (x==y); 	// NOSONAR MatoG 4.10.2011: chceme porovnavat na ==
		}
		if ((param1 instanceof Complex) && (param2 instanceof Complex))
		{
		...
		/**
		 *	MatoG 27.4.2005 upravil: povodne sa zvlast riesili komplexne cisla a zvysok isiel cez equals,
		 *  co ale davalo zle vysledky: neplatilo povedzme Integer( 2 ) == 2, lebo konstanta bola autoamticky Double
		 */
		if( ( param1 instanceof Number ) && ( param2 instanceof Number ) && !param1.getClass().equals( param2.getClass() ) ) {
   		double x = ((Number)param1).doubleValue();
   		double y = ((Number)param2).doubleValue();
   		return (x==y);		// NOSONAR MatoG 4.10.2011: chceme porovnavat na ==
		}		
