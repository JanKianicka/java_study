...
public class Dot extends PostfixMathCommand
{
	...
	public Object dot(Object param1, Object param2)
		throws ParseException
	{
		if (param1 instanceof Vector && param2 instanceof Vector)	// NOSONAR musi byt Vector
		{
			return dot((Vector) param1,(Vector) param2);	// NOSONAR musi byt Vector
		}
		throw new ParseException("Dot: Invalid parameter type, both arguments must be vectors");
	}
	

	public Object dot(Vector v1,Vector v2) throws ParseException	// NOSONAR musi byt Vector
	{
		if(v1.size()!=v2.size()) {
