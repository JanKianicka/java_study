...
public class Divide extends PostfixMathCommand
{
		...
		throws ParseException
	{
		if (param1 instanceof Complex)
		{
			...
			} else if (param2 instanceof Vector) {	// NOSONAR musi byt Vector
				return div((Complex)param1, (Vector)param2);	// NOSONAR musi byt Vector
			}
		}
		else if (param1 instanceof Number)
		{
			if (param2 instanceof Complex) {
				...
				return div((Number)param1, (Vector)param2);		// NOSONAR musi byt Vector
			}
		}
		else if (param1 instanceof Vector)		// NOSONAR musi byt Vector
		{
			if (param2 instanceof Complex) {
				return div((Vector)param1, (Complex)param2);	// NOSONAR musi byt Vector
			} else if (param2 instanceof Number) {
				return div((Vector)param1, (Number)param2);		// NOSONAR musi byt Vector
			}
		}
	...
	public Vector div(Vector v, Number d)		// NOSONAR musi byt Vector
	{
		Vector result = new Vector();			// NOSONAR musi byt Vector
	...
	public Vector div(Number d, Vector v)		// NOSONAR musi byt Vector
	{
		Vector result = new Vector();		// NOSONAR musi byt Vector
	...
	public Vector div(Vector v, Complex c)	// NOSONAR musi byt Vector
	{
		Vector result = new Vector();	// NOSONAR musi byt Vector
	...
	public Vector div(Complex c, Vector v)	// NOSONAR musi byt Vector
	{
		Vector result = new Vector();	// NOSONAR musi byt Vector
