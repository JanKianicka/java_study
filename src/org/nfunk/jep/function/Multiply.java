...
public class Multiply extends PostfixMathCommand
{
		...
		throws ParseException
	{
		if (param1 instanceof Complex)
		{
			if (param2 instanceof Complex) {
				...
				return mul((Vector)param2, (Complex)param1);	// NOSONAR musi byt Vector
			}
		}
		else if (param1 instanceof Number)
		{
			if (param2 instanceof Complex) {
				...
				return mul((Vector)param2, (Number)param1);		// NOSONAR musi byt Vector
			}
		}
		else if (param1 instanceof Vector)						// NOSONAR musi byt Vector
		{
			if (param2 instanceof Complex) {
				return mul((Vector)param1, (Complex)param2);	// NOSONAR musi byt Vector
			} else if (param2 instanceof Number) {
				return mul((Vector)param1, (Number)param2);		// NOSONAR musi byt Vector
			}
		}
	...
	public Vector mul(Vector v, Number d)		// NOSONAR musi byt Vector
	{
	...
	public Vector mul(Vector v, Complex c)		// NOSONAR musi byt Vector
	{
		Vector result = new Vector();			// NOSONAR musi byt Vector
