 ...
 * $Id: Parser.java,v 1.11 2014/06/25 13:16:50 matog Exp $ 
 * */
...
***************************************************************/
 ...
 /*@bgen(jjtree) Start */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      if (jj_2_1(1)) {
        ...
        default:
    ...
    } catch (Throwable jjte000) {	//NOSONAR kvoli spatnej kompatibilite chytame Throwable
          if (jjtc000) {
          ...
          if (true){ throw (Error)jjte000;}	// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
    } finally {
          if (jjtc000) {
            jjtree.closeNodeScope(jjtn000, true);
          }
...
// x=y=3 parsed as x=(y=3)
  ...
  public final void assignExpression() throws ParseException {
    ...
    try {
      ...
      expression();
    ...
    } catch (Throwable jjte001) {	//NOSONAR kvoli spatnej kompatibilite chytame Throwable
          if (jjtc001) {
         ...
         if (true) { throw (Error)jjte001;}	// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
    } finally {
          if (jjtc001) {
            jjtree.closeNodeScope(jjtn001,  2);
          }
  ...
  final public void equalExpression() throws ParseException {
    ...
    while (true) {
      ...
      case EQ:
        ...
        try {
          ...
          relationalExpression();
        ...
        } catch (Throwable jjte002) {	//NOSONAR kvoli spatnej kompatibilite chytame Throwable
            if (jjtc002) {
            ...
            if (true){ throw (Error)jjte002;}	// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
        } finally {
            if (jjtc002) {
              jjtree.closeNodeScope(jjtn002,  2);
            }
    ...
    while (true) {
     ...
     if (true) { throw (Error)jjte001;}		// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
      ...
      jjtree.openNodeScope(jjtn003);
        ...
        } catch (Throwable jjte003) {	//NOSONAR kvoli spatnej kompatibilite chytame Throwable
      if (jjtc003) {
     ...
     if (true) { throw (Error)jjte003;}		// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
        } finally {
      if (jjtc003) {
        jjtree.closeNodeScope(jjtn003,  2);
      }
      ...
      jjtree.openNodeScope(jjtn004);
        ...
        } catch (Throwable jjte004) {	//NOSONAR kvoli spatnej kompatibilite chytame Throwable
      if (jjtc004) {
      ...
      if (true){ throw (Error)jjte004;}		// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
        } finally {
      if (jjtc004) {
        jjtree.closeNodeScope(jjtn004,  2);
      }
     ...
     if (true) { throw (Error)jjte001;}		// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
      ...
      jjtree.openNodeScope(jjtn005);
        ...
        jjtn005.setOperator(opSet.getDivide());
          } catch (Throwable jjte005) {		//NOSONAR kvoli spatnej kompatibilite chytame Throwable
      if (jjtc005) {
      ...
      if (true){ throw (Error)jjte005;}		// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
          } finally {
      if (jjtc005) {
        jjtree.closeNodeScope(jjtn005,  2);
      }
      ...
      jjtree.openNodeScope(jjtn006);
        ...
        jjtn006.setOperator(opSet.getMod());
          } catch (Throwable jjte006) {		//NOSONAR kvoli spatnej kompatibilite chytame Throwable
      if (jjtc006) {
      ...
      if (true){ throw (Error)jjte006;}		// NOSONAR MatoG 4.10.2011: chybu "Dodgy - Unchecked/unconfirmed cast " neriesime
          } finally {
      if (jjtc006) {
        jjtree.closeNodeScope(jjtn006,  2);
      }
...
*/
  ...
  private final boolean jj_2_1(int xla) {
    jj_la = xla; jj_lastpos = token; jj_scanpos = token;
    try { return !jj_3_1(); }
  ...
  private final boolean jj_2_8(int xla) {
    jj_la = xla; jj_lastpos = jj_scanpos = token;	// NOSONAR inner assignment neriesime
    try { return !jj_3_8(); }
    catch(LookaheadSuccess ls) { return true; }
  ...
  static private int[] jj_la1_0;	// NOSONAR meno premennej nemenime
  static private int[] jj_la1_1;	// NOSONAR meno premennej nemenime
  static {
      jj_la1_0();
      jj_la1_1();
   }
  ...
  final private Token jj_consume_token(int kind) throws ParseException {
    Token oldToken;
    if ((oldToken = token).next != null) {token = token.next;}	// NOSONAR inner assignment neriesime
    else{ token = token.next = token_source.getNextToken();}	// NOSONAR inner assignment neriesime
    jj_ntk = -1;
    if (token.kind == kind) {
      jj_gen++;
      if (++jj_gc > 100) {
  ...
  final private boolean jj_scan_token(int kind) {
    if (jj_scanpos == jj_lastpos) {
      ...
      if (jj_scanpos.next == null) {
        jj_lastpos = jj_scanpos = jj_scanpos.next = token_source.getNextToken();	// NOSONAR inner assignment neriesime
      } else {
        jj_lastpos = jj_scanpos = jj_scanpos.next;		// NOSONAR inner assignment neriesime
      }
    } else {
  ...
  final public Token getToken(int index) {
    ...
    for (int i = 0; i < index; i++) {
      ...
      else{ t = t.next = token_source.getNextToken();}		// NOSONAR inner assignment neriesime
    }
    return t;
  }

  final private int jj_ntk() {	
    if ((jj_nt=token.next) == null){				// NOSONAR inner assignment neriesime
      return (jj_ntk = (token.next=token_source.getNextToken()).kind);	// NOSONAR inner assignment neriesime
    } else{
      return (jj_ntk = jj_nt.kind);					// NOSONAR inner assignment neriesime
  }
    }
  ...
  private void jj_add_error_token(int kind, int pos) {
    ...
    if (pos == jj_endpos + 1) {
      ...
      if (pos != 0) {jj_lasttokens[(jj_endpos = pos) - 1] = kind;}		// NOSONAR inner assignment neriesime
    }
  }
  ...
  final private void jj_rescan_token() {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      do {
        if (p.gen > jj_gen) {
          jj_la = p.arg; jj_lastpos = jj_scanpos = p.first;	// NOSONAR inner assignment neriesime
          switch (i) {
            case 0: jj_3_1(); break;
            case 1: jj_3_2(); break;
            case 2: jj_3_3(); break;
  ...
  final private void jj_save(int index, int xla) {
    ...
    while (p.gen > jj_gen) {
      if (p.next == null) { p = p.next = new JJCalls(); break; }	// NOSONAR inner assignment neriesime
      p = p.next;
    }
