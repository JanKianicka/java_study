 ...
 * $Id: EvaluatorVisitor.java,v 1.4 2012/03/02 09:40:20 matog Exp $
 */
...
public class EvaluatorVisitor implements ParserVisitor {
	...
	protected Vector errorList;	// NOSONAR Vector -> ArrayList neriesime
	...
	public Object getValue(
		Node topNode,
		Vector errorList_in,	// NOSONAR Vector-> ArrayList neriesime
		SymbolTable symTab_in)
		throws Exception {	// NOSONAR kvoli spatnej kompatibilite Exception
		...
		if (errorFlag || stack.size() != 1) {
			throw new Exception("EvaluatorVisitor.getValue(): Error during evaluation");	// NOSONAR raw exception neriesime	
		}
	...
	public Object visit(ASTFunNode node, Object data) throws ParseException {
		...
		data = node.childrenAccept(this, data);	// NOSONAR parameter assignment neriesime
